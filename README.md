...
* **GPU:** NVIDIA GeForce RTX 3060 Ti (CUDA Enabled)
...
(Documentation on how to set up the environment, download the dataset, and run the training script will be updated as the pipeline matures.)